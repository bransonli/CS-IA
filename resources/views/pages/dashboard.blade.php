            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    @foreach ($subjects as $subject)
                        <a href="/subjects/{{$subject->name}}/discussion"><button type="button" class="btn btn-light" style="width: 15%;">{{ $subject->name }}</button></a>
                    @endforeach
                </div>
            </div>
        </div>
    ...
    <div style="padding-bottom: 8%;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    @foreach ($subjects as $subject)
                        <a href="/subjects/{{$subject->name}}/note"><button type="button" class="btn btn-light " style="width: 15%;">{{ $subject->name }}</button></a>
                    @endforeach
                </div>
            </div>
        </div>
    ...
    <div style="padding-bottom: 8%;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    @foreach ($subjects as $subject)
                        <a href="/subjects/{{$subject->name}}/resource"><button type="button" class="btn btn-light " style="width: 15%;">{{ $subject->name }}</button></a>
                    @endforeach
                </div>
            </div>
        </div>
